...
代码、冻结协议、详细报告、小型派生表、hash/manifest 与阴性结果已同步到：
https://github.com/1209433622cz-maker/igan-open-regulatory-evidence

未上传第三方 GWAS、QTL、donor genotype 或 GJOKA 大型 LD 字节；公共仓库的 `data/LARGE_DATA_MANIFEST.tsv` 记录其 URL、大小、hash 和本地目标路径。最终远端 commit 写入发布包根目录 `GITHUB_PUBLICATION.txt`。
"""
}
